...
export default class ExitYesHandler extends HandlerBase {
  ...
  async respond() {
    ...
    alexaConvo.saveToStorage(AgentConstants.STORAGE_SAVED_STORE_KEY,
                             alexaConvo.getStorage(AgentConstants.STORAGE_MOST_RECENT_STORE_KEY));
    ...
    this.alexa.emit(':tell', ExitDialogFactory.sayGoodByeSaved());
  }
}
