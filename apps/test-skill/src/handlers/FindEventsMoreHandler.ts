...
export default class FindEventsMoreHandler extends HandlerBase {
  ...
  async respond() {
    ...
    convoResponse = await StoreUtil.launchMoreAboutEventConvo(alexaConvo, (finalResponse) => {
...
console.log("MORE STATE: " + JSON.stringify(this.alexa.handler.state))
