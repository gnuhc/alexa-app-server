    ...
    respond() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (alexaConvo.getStorage('saved_store')) {
                ...
                alexaConvo.deleteFromStorage(AgentConstants_1.default.STORAGE_SAVED_STORE_KEY);
                data.updateUser(this.alexaUserId, alexaConvo.alexa.attributes, this.user);
                alexaConvo.ask(ForgetDialogFactory_1.default.askForget());
            }
            else {
                this.alexa.handler.state = 'EVENTS_MAIN_EXIST';
                alexaConvo.ask(ForgetDialogFactory_1.default.askNotForget());
            }
        });
    }
}
