...
class YesIntentHandler extends HandlerBase_1.default {
    constructor(alexa) {
        super(alexa);
    }
    respond() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("STATE: " + this.alexa.handler.state);
            if (alexaConvo.alexa.attributes.faqIntent) {
                console.log("HAS FAQINTENT");
                ...
                console.log("HAS EVENTS_MAIN_ONE_EXIST");
...
exports.default = YesIntentHandler;
//# sourceMappingURL=YesIntentHandler.js.map