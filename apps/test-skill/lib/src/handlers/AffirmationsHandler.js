...
const AffirmationsDialogFactory_1 = require("../shared/dialog/AffirmationsDialogFactory");
const DynamoDBUtil_1 = require("../utils/DynamoDBUtil");
const AgentConstants_1 = require("../shared/AgentConstants");
class AffirmationsHandler extends HandlerBase_1.default {
    constructor(alexa) {
        super(alexa);
    }
    respond() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = AffirmationsDialogFactory_1.default.getNextAffirmation(alexaConvo);
...
exports.default = AffirmationsHandler;
//# sourceMappingURL=AffirmationsHandler.js.map