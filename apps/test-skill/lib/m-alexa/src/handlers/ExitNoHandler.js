...
class ExitNoHandler extends HandlerBase_1.default {
    constructor(alexa) {
        super(alexa);
    }
    respond() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            alexaConvo.removeFromStorage(AgentConstants_1.default.STORAGE_MOST_RECENT_STORE_KEY);
            ...
            alexaConvo.removeFromStorage(AgentConstants_1.default.STORAGE_EVENT_INDEX_KEY);
            alexaConvo.removeFromStorage(AgentConstants_1.default.STORAGE_EVENTS_LEFT_KEY);
            alexaConvo.removeFromStorage(AgentConstants_1.default.STORAGE_REPEAT_KEY);
            data.updateUser(this.alexaUserId, alexaConvo.alexa.attributes, this.user);
            this.alexa.emit(':tell', ExitDialogFactory_1.default.sayGoodByeNotSaved());
        });
    }
}
exports.default = ExitNoHandler;
//# sourceMappingURL=ExitNoHandler.js.map