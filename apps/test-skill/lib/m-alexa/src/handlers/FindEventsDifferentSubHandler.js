...
class FindEventsDifferentSubHandler extends HandlerBase_1.default {
    ...
    respond() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.alexa.emit(':ask', 'What location are you interested in? Tell me a City and State or a zip code.', 'What location are you interested in? Tell me a City and State or a zip code.');
        });
    }
}
